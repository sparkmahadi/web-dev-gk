...
const Blog = () => {
    return (
        <div className='min-h-screen md:px-10 lg:px-44 2xl:px-80 my-blog'>
            <div data-aos="zoom-in" className='border border-cyan-400 p-5 m-5 rounded-lg shadow-lg custom-bg'>
